...
function SmartWizard(target, options) {
    ...
    this.loader = $('<div>Cargando</div>').addClass("loader");
    this.buttons = {
        next : $('<a id="sw-btn-next">'+options.labelNext+' <i class="fa fa-arrow-right"></i></a>').attr("href","#").addClass("btn btn-primary"),
        previous : $('<a id="sw-btn-prev"><i class="fa fa-arrow-left"></i> '+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-primary"),
        finish  : $('<a><i class="fa fa-save"></i>'+options.labelFinish+'</a>').attr("href","#").addClass("btn btn-success")
    };
    this.clickN=options.clickNext;
    this.clickP=options.clickPrevious;
    this.clickF=options.clickFinish;

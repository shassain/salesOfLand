        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                @component("component.xpanel",["title"=>"Registrar Proyecto"])
                  {!!Form::open(["route"=>["proyecto.update",$proyecto->id],"method"=>"put","role"=>"form"])!!}
                      ...
                      <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-9"><input name="nombre" value="{{$proyecto->nombre}}" type="text" class="form-control input-sm"></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <textarea name="descripcion" id="configtextarea" cols="30" rows="6" >{!!$proyecto->descripcion!!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                      <textarea name="lista" id="configtextarea2" cols="30" rows="7" >{!!$proyecto->lista!!}</textarea>
                  ...
                  <input type="hidden" id="posx" name="posx" value="{{$proyecto->posx}}">
                  <input type="hidden" id="posy" name="posy" value="{{$proyecto->posy}}">
                  {!!Form::close()!!}
                @endcomponent
            </div>
            <div class="col-md-12">
